...
const drawMap = (laureates, countries)=>{
    ...
    laureates.forEach((laureate)=>{
        if (laureate.birth_country !== "") {
            ...
            if (country.laureates) country.laureates.push(laureate);
            else country["laureates"] = [
                laureate
            ];
        }
    });
    ...
    svg.selectAll(".path-mercator").data(countries.features).join("path").attr("class", "countries path-mercator").attr("d", geoPathGenerator);
};

},{"d3-selection":"gn9gd","d3-geo":"01Z75","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gn9gd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
